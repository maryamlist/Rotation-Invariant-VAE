...
class SpatialGenerator(nn.Module):
    def __init__(self, latent_dim, hidden_dim, n_out=1, num_layers=1, activation=nn.LeakyReLU
        ...
        #layers.append(nn.Sigmoid()) #added
...
#        self.conv3 = nn.Conv3d(self.kernels_num, self.kernels_num, 1)
#        self.conv4 = nn.Conv3d(self.kernels_num, self.kernels_num, 1)
    ...
    def forward(self, x, device):
        ...
        h = self.activation(self.conv4(x)) 
